...
export const RecordSearch: React.FC<RecordSearchProps> = ({
    ...
    return (
        <div className="flex flex-col h-full bg-white rounded-xl overflow-hidden shadow-xs border border-gray-100" id="record-search-view">
            ...
            <div className="p-3 md:p-4 border-b border-gray-100 bg-white flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 shrink-0">
                <h2 className="text-base md:text-lg font-bold text-gray-800 flex items-center gap-2 shrink-0">
