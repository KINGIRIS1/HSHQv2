    ...
    reader.onload = (evt) => {
      try {
        ...
        const typeMapping: Record<string, string> = {
            ...
            'CN SỐ THỬA': '2.3 Duyệt đơn-số thửa', 'CẬP NHẬT SỐ THỬA': '2.3 Duyệt đơn-số thửa', 'CẬP NHẬP SỐ THỬA': '2.3 Duyệt đơn-số thửa', '2.3': '2.3 Duyệt đơn-số thửa', '2.6': '2.3 Duyệt đơn-số thửa',
